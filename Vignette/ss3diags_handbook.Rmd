...
output:
  rmarkdown::html_vignette:
    ...
    fig_height: 5
vignette: >
  %\VignetteIndexEntry{User Guidelines for Advanced Model Diagnostics with ss3diags} 
...
```{r, echo = FALSE}
knitr::opts_chunk$set(collapse = TRUE, comment = "  " ,fig.align = 'center', cache=FALSE,tidy.opts=list(width.cutoff=50), tidy=TRUE)
