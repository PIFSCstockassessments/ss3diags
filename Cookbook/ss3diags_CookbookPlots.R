...
SSplotJABBAres(ss3sma,subplots = "len", add=T,legendcex=0.8,tickEndYr=F,xylabs=T,legendsp = 1)
legend("topleft",paste0(letters[3],")"),y.intersp = -0.2,x.intersp = -0.7,bty="n",cex=l)
SSplotJABBAres(ss3phk,subplots = "age",add=T,legendcex=0.8,tickEndYr=F,xylabs=T,legendsp = 1)
