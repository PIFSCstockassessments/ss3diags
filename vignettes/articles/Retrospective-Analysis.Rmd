...
SSplotRetro(retroSummary, add = TRUE)
...
SSplotRetro(retrosum, subplots = "SSB", add = TRUE, uncertainty = FALSE)
SSplotRetro(retrosum, subplots = "SSB", add = TRUE,  uncertainty = FALSE, xlim = c(2010, 2023))
SSplotRetro(retrosum, subplots = "SSB", add = TRUE,  uncertainty = FALSE, xlim = c(2010, 2023), forecast = FALSE)
SSplotRetro(retrosum, subplots = "SSB", add = TRUE,  uncertainty = FALSE, xlim = c(2010, 2023), forecast = FALSE, showrho = FALSE, forecastrho = FALSE)
