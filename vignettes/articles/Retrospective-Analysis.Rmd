...
SSplotRetro(retroSummary, subplots = "SSB", add = TRUE,  uncertainty = FALSE, xlim = c(2010, 2023))
SSplotRetro(retroSummary, subplots = "SSB", add = TRUE,  uncertainty = FALSE, xlim = c(2010, 2023), forecast = FALSE)
SSplotRetro(retroSummary, subplots = "SSB", add = TRUE,  uncertainty = FALSE, xlim = c(2010, 2023), forecast = FALSE, showrho = FALSE, forecastrho = FALSE)
