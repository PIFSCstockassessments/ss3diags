...
```{r}
r4ss::run(dir = dir_tmp, verbose = FALSE, exe = "ss3.exe")
files <- c("data_echo.ss_new", "control.ss_new", "starter.ss", "forecast.ss", "ss.par", "ss3.exe")
...
```{r}
r4ss::run(dir = dir_aspm, exe = "ss3.exe", skipfinished = FALSE, verbose = FALSE)
```
